  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <p className="text-muted-foreground mb-8">この場所についての詳細な体験を共有しましょう！</p>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  {rating > 0 && (
                    <span className="ml-2 text-sm self-center">{rating} / 5</span>
                  )}
                </div>
              </div>

              <div>
                <Label htmlFor="comment" className="mb-2 block">体験・コメント</Label>
                <Textarea
                  id="comment"
              ...
              {spot.reviews.map((review) => (
                <Card key={review.id} className="p-4">
                  ...
                  <div className="flex justify-between items-center text-xs text-muted-foreground">
                    <span>Posted by {review.userName} • {review.date}</span>
                    <div className="flex gap-2">
                      <button className="text-primary hover:underline">編集</button>
                      <button className="text-destructive hover:underline">削除</button>
                    </div>
                  </div>
                </Card>
              ))}
